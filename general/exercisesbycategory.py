...
""")
q1="select * from content where category='Exercises' and technology='"+type+"' and ctype='text' and ctopic='"+topic+"'"
cur.execute(q1)
res1=cur.fetchall()
if res1:
	for r1 in res1:
...
""")
q1="select * from content where category='Exercises' and technology='"+type+"' and ctype='Video'and ctopic='"+topic+"'"
cur.execute(q1)
res1=cur.fetchall()
if res1:
	for r1 in res1:
...
""")
q1="select * from content where category='Exercises' and technology='"+type+"' and ctype='Audio'and ctopic='"+topic+"'"
cur.execute(q1)
res1=cur.fetchall()
if res1:
	for r1 in res1:
...
""")
q1="select * from content where category='Exercises' and technology='"+type+"' and ctype='Pdf'and ctopic='"+topic+"'"
cur.execute(q1)
res1=cur.fetchall()
if res1:
	for r1 in res1:
