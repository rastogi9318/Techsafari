...
cur=con.cursor()
q="select distinct ctopic from content where category='Tutorial' and Technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 print "<a href='tutorialbycategory.py?type="+type+"&topic="+r[0]+"'><h4><xmp>"+r[0]+"</xmp></h4></a>"
print ("""
</div>
...
""")
q="select distinct ctopic from content where category='Tutorial' and ctype='text' and technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 q1="select * from content where category='Tutorial' and technology='"+type+"' and ctype='text'"
 cur.execute(q1)
 res1=cur.fetchall()
if res:
 for r1 in res1:
...
""")
q="select distinct ctopic from content where category='Tutorial' and ctype='Video' and technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 q1="select * from content where category='Tutorial' and technology='"+type+"' and ctype='Video'"
 cur.execute(q1)
 res1=cur.fetchall()
if res: 
 for r1 in res1:
...
""")
q="select distinct ctopic from content where category='Tutorial' and ctype='Audio' and technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 q1="select * from content where category='Tutorial' and technology='"+type+"' and ctype='Audio'"
 cur.execute(q1)
 res1=cur.fetchall()
if res:
 for r1 in res1:
  print """<h2><xmp>""",r1[4],"""</xmp>
  </h2><hr/><audio controls width="100%"><source src="../contentfile/"""+str(r1[7])+""""/></audio>
  <br/>By : """,r1[1],"""
  """
else:
 print("<h1>Data Not Found!</h1>")
...
""")
q="select distinct ctopic from content where category='Tutorial' and ctype='Pdf' and technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 q1="select * from content where category='Tutorial' and technology='"+type+"' and ctype='Pdf'"
 cur.execute(q1)
 res1=cur.fetchall()
if res:
 for r1 in res1:
  ...
  <a href="../contentfile/"""+str(r1[7])+""""><i class="fa fa-file-pdf-o" aria-hidden="true"></i>""",r1[4],"""</a>
  <br/>By : """,r1[1],"""
  """
else:
 print("<h1>Data Not Found!</h1>")
