...
cur=con.cursor()
q="select distinct ctopic from content where category='Exercises' and Technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 print "<a href='exercisesbycategory.py?type="+type+"&topic="+r[0]+"'><h4><xmp>"+r[0]+"</xmp></h4></a>"
print ("""
</div>
...
""")
q="select distinct ctopic from content where category='Exercises' and ctype='text' and technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 q1="select * from content where category='Exercises' and technology='"+type+"' and ctype='text'"
 cur.execute(q1)
 res1=cur.fetchall()
if res:
 for r1 in res1:
  print """<h2><xmp>""",r1[4],"""</xmp>
  </h2><hr/><pre style="font-size:20px;padding:1%;background:white;box-shadow:0px 1px 1px black"><code><xmp>""",r1[6],"""</xmp></code></pre> By : """,r1[1],""""""
else:
...
""")
q="select distinct ctopic from content where category='Exercises' and ctype='Video' and technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 q1="select * from content where category='Exercises' and technology='"+type+"' and ctype='Video'"
 cur.execute(q1)
 res1=cur.fetchall()
if res: 
 for r1 in res1:
...
""")
q="select distinct ctopic from content where category='Exercises' and ctype='Audio' and technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 q1="select * from content where category='Exercises' and technology='"+type+"' and ctype='Audio'"
 cur.execute(q1)
 res1=cur.fetchall()
if res:
 for r1 in res1:
...
""")
q="select distinct ctopic from content where category='Exercises' and ctype='Pdf' and technology='"+type+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 q1="select * from content where category='Exercises' and technology='"+type+"' and ctype='Pdf'"
 cur.execute(q1)
 res1=cur.fetchall()
if res:
 for r1 in res1:
