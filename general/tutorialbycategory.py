...
""")
q1="select * from content where category='Tutorial' and technology='"+type+"' and ctype='text' and ctopic='"+topic+"'"
cur.execute(q1)
res1=cur.fetchall()
if res1:
	for r1 in res1:
		print """<h2><xmp>"""+str(topic)+"""</xmp>
		</h2><hr/><pre style="font-size:20px;padding:1%;background:white;box-shadow:0px 1px 1px black"><code><xmp>"""+str(r1[6])+"""</xmp></code></pre><br/>By : """,r1[1],""""""
else:
...
""")
q1="select * from content where category='Tutorial' and technology='"+type+"' and ctype='Video'and ctopic='"+topic+"'"
cur.execute(q1)
res1=cur.fetchall()
if res1:
	for r1 in res1:
...
""")
q1="select * from content where category='Tutorial' and technology='"+type+"' and ctype='Audio'and ctopic='"+topic+"'"
cur.execute(q1)
res1=cur.fetchall()
if res1:
	for r1 in res1:
...
""")
q1="select * from content where category='Tutorial' and technology='"+type+"' and ctype='Pdf'and ctopic='"+topic+"'"
cur.execute(q1)
res1=cur.fetchall()
if res1:
	for r1 in res1:
		...
		<a href="../contentfile/"""+str(r1[7])+""""><i class="fa fa-file-pdf-o" aria-hidden="true"></i>""",r1[4],"""</a><br/><br/>By : """,r1[1],"""
		"""
else:
	print("<h1>Data Not Found!</h1>")
print("""
