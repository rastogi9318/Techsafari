...
cur=con.cursor()
q="select user,category,technology,ctopic,ctype,cdescription,media,curr_date,srn from content order by ctype"
cur.execute(q)
res=cur.fetchall()
print("""
...
for r in res:
	if r[1]=='Tutorial':
		if r[4]=='Text':
			...
			<hr/><pre style="font-size:20px;padding:1%;background:white;box-shadow:0px 1px 1px black;line-height:15px;"><code><xmp>"""+str(r[5])+"""</xmp></code></pre><b>By : """+str(r[0])+"""</b> on <b>Date : """+str(r[7])+"""</b> <a href="../code/contentmnggdb1.py?msg="""+str(r[8])+"""" style='text-decoration:none;font-size:25px;'><i class='fa fa-trash'style='color:orange;'></i></a>
			</div>
			""")
		elif r[4]=='Video':
			print("""
			...
			<b>By : """+str(r[0])+"""</b> on <b>Date:"""+str(r[7])+"""</b><a href="../code/contentmnggdb1.py?msg="""+str(r[8])+"""&fln="""+str(r[6])+""""style='text-decoration:none;font-size:25px;'><i class='fa fa-trash'style='color:orange;'></i></a>
			</div>
			""")
		elif r[4]=='Audio':
			print(""" 
			...
			<br/><br/><b>By : """+str(r[0])+"""</b> on <b>Date:"""+str(r[7])+"""</b><a href="../code/contentmnggdb1.py?msg="""+str(r[8])+"""&fln="""+str(r[6])+""""style='text-decoration:none;font-size:25px;'><i class='fa fa-trash'style='color:orange;'></i></a>
			</div>
			<style>
			#inpdf{
