...
for a in res:
	i=i+1
	print"<tr><td>",i,"</td><td>",a[0],"</td><td>",a[1],"</td><td style='text-align:center;'><a href='../code/subscriberdb.py?msg="+str(a[0])+"'style='text-decoration:none;'><i class='fa fa-trash'style='color:orange;'></i></a></td></tr>"
print("""
		</table>
		</div>
	</div>
